...
export const perksData = [
  {
    icon: <ElearningExchangeIcon color="#5e3a9d" size={ICON_SIZE} />,
    title: "Education",
    description:
  ...
  {
    icon: <Brain01Icon color="#5e3a9d" size={ICON_SIZE} />,
    title: "Well-Being",
    description:
  ...
  {
    icon: <ViewOffSlashIcon color="#5e3a9d" size={ICON_SIZE} />,
    title: "Transparency",
    description:
  ...
  {
    icon: <WorkoutWarmUpIcon color="#5e3a9d" size={ICON_SIZE} />,
    title: "Exercise",
    description:
  ...
  {
    icon: <UserGroupIcon color="#5e3a9d" size={ICON_SIZE} />,
    title: "Conferences",
    description:
      "We organize conferences two times a year where we spend time together to learn and to bond.",
  },
  {
    icon: <Activity03Icon color="#5e3a9d" size={ICON_SIZE} />,
    title: "Activities",
    description:
  ...
  {
    icon: <Target01Icon color="#5e3a9d" size={ICON_SIZE} />,
